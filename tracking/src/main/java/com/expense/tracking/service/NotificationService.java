...
public class NotificationService {
    ...
    public NotificationResponse createBudgetAlert(double percentage, double spent, double budget) {
        ...
        String message = String.format("You've spent %.1f%% of your budget (₹%.2f / ₹%.2f)", 
    ...
    public NotificationResponse createStreakReward(int days) {
        NotificationRequest request = NotificationRequest.builder()
                .title("Streak Reward! 🎉")
                .message(String.format("You've logged expenses %d days in a row – keep it up!", days))
    ...
    public NotificationResponse createWeeklySummary(double totalSpent, String topCategory) {
        NotificationRequest request = NotificationRequest.builder()
                ...
                .message(String.format("This week you spent ₹%.2f. Top category: %s", totalSpent, topCategory))
